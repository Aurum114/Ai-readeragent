...
.logo:hover {
  ...
  background: linear-gradient(135deg, #ff4d88 0%, #ff7aa2 100%);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
}
...
.divider {
  width: 2px;
  height: 28px;
  background: linear-gradient(to bottom, rgba(255, 122, 162, 0.1), rgba(255, 77, 136, 0.1));
  margin: 0 8px;
}
