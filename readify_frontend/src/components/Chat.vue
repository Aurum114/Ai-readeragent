      ...
      <div class="input-wrapper">
        ...
        <div class="select-container">
          <el-select 
            ...
            class="mode-select"
            disabled
            style="--el-select-border-radius: 40px; --el-select-input-focus-border-color: #ff7aa2; --el-border-radius-base: 40px; border-radius: 40px; --el-fill-color-light: rgb(255, 240, 246); --el-fill-color-blank: rgb(255, 240, 246); --el-fill-color: rgb(255, 240, 246); background-color: rgb(255, 240, 246);"
          >
            <template #prefix>
...
.mode-select :deep(.el-input__wrapper) {
  ...
  border: 0px solid #ff7aa2 !important;
...
.mode-select :deep(.el-input__wrapper) {
  border-radius: 40px !important;
  overflow: hidden !important;
  border: 2px solid #ff7aa2 !important;
