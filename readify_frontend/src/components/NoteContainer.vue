          ...
          <div class="input-wrapper">
            ...
            <div class="select-container">
              <el-select 
                ...
                class="mode-select"
                disabled
                style="--el-select-border-radius: 40px; --el-select-input-focus-border-color: #ff7aa2; --el-border-radius-base: 40px; border-radius: 40px; --el-fill-color-light: #ffffff; --el-fill-color-blank: #ffffff; --el-fill-color: #ffffff; background-color: #ffffff;"
              >
                <template #prefix>
              ...
              <el-select v-model="vendor" size="small" class="model-select"
                 style="--el-border-radius-base: 40px; border-radius: 40px; background-color: #ffffff;"
              >
                <template #prefix>
